  ...
  const founders = [
    {
      ...
      email: "keshav@chetna-ai.vercel.app",
    ...
    },
    {
      ...
      email: "ashutosh@chetna-ai.vercel.app",
    ...
    },
    {
      ...
      email: "anchal@chetna-ai.vercel.app",
  ...
  return (
    <PageLayout>
      <Helmet>
        ...
        <link rel="canonical" href="https://chetna-ai.vercel.app/contact-team" />
      </Helmet>
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                onClick={() => window.location.href = 'mailto:hello@chetna-ai.vercel.app'}
              >
                <Mail className="h-4 w-4" />
                hello@chetna-ai.vercel.app
              </Button>
              
              <Button 
                variant="outline"
                className="gap-2 hover:bg-chetna-primary/10"
                onClick={() => window.open('https://chetna-ai.vercel.app', '_blank')}
              >
