  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-chetna-light via-white to-chetna-secondary/10">
      <Helmet>
        ...
        <link rel="canonical" href="https://chetna-ai.vercel.app/psych-tests" />
      </Helmet>
            ...
            <Card className="bg-chetna-primary/5 border-chetna-primary/20 shadow-lg">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  If you're experiencing mental health concerns, please consult with a qualified healthcare provider or chat with Chetna AI.
                </p>
              </CardContent>
            </Card>
          </div>
