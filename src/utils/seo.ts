...
export const generateSEOConfig = (config: SEOConfig): SEOConfig => {
  const baseUrl = 'https://empath-space-well.vercel.app';
...
export const pageSEO = {
  ...
  aiFeatures: {
    ...
    url: 'https://empath-space-well.vercel.app/ai-features',
  },
  about: {
    ...
    url: 'https://empath-space-well.vercel.app/about',
  },
  blog: {
  ...
  resources: {
    ...
    url: 'https://empath-space-well.vercel.app/resources',
  },
  psychTests: {
    ...
    url: 'https://empath-space-well.vercel.app/psych-tests',
  },
  appointments: {
    ...
    url: 'https://empath-space-well.vercel.app/appointments',
  },
  moodTracker: {
    ...
    url: 'https://empath-space-well.vercel.app/mood-tracker',
  },
  journal: {
    ...
    url: 'https://empath-space-well.vercel.app/journal',
  },
  community: {
    ...
    url: 'https://empath-space-well.vercel.app/community',
  },
  crisisSupport: {
    ...
    url: 'https://empath-space-well.vercel.app/crisis-support',
  },
  pricing: {
    ...
    url: 'https://empath-space-well.vercel.app/pricing',
  },
  dreamAnalysis: {
    ...
    url: 'https://empath-space-well.vercel.app/dream-analysis',
  },
  emotionRecognition: {
    ...
    url: 'https://empath-space-well.vercel.app/emotion-recognition',
  },
  voiceTherapy: {
    ...
    url: 'https://empath-space-well.vercel.app/voice-therapy',
  },
  mentalHealthGoals: {
    ...
    url: 'https://empath-space-well.vercel.app/mental-health-goals',
  },
  wellnessPlans: {
    ...
    url: 'https://empath-space-well.vercel.app/wellness-plans',
  },
};
...
export const generateArticleSchema = (article: {
  ...
  return {
    ...
    image: article.image || 'https://empath-space-well.vercel.app/og-image.png',
    url: article.url,
    publisher: {
      '@type': 'Organization',
      name: 'Chetna AI',
