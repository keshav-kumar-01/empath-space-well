...
import { Heart, MessageSquare, Star, Shield, Brain } from "lucide-react";
  ...
  return (
    <div className="text-center space-y-8 py-8 animate-fade-in">
      <div className="flex justify-center">
        <div className="w-20 h-20 bg-gradient-to-br from-chetna-primary/20 to-chetna-primary/5 rounded-full flex items-center justify-center transform hover:scale-110 transition-all duration-500 shadow-md">
