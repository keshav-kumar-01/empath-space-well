...
const UsageDashboard: React.FC = () => {
  const { userSubscription, userUsage, getRemainingUsage } = useSubscription();
  const navigate = useNavigate();

  if (!userSubscription || !userUsage) {
    return (
      <Card>
  ...
  const usageItems = [
    {
      ...
      icon: MessageCircle,
      used: userUsage.ai_conversations_used,
      limit: userSubscription.ai_conversations_limit,
      color: 'text-blue-600',
      bgColor: 'bg-blue-100',
    },
    {
      ...
      icon: Users,
      used: userUsage.professional_sessions_used,
      limit: userSubscription.professional_sessions_limit,
    ...
    },
    {
      ...
      icon: Brain,
      used: userUsage.psychological_assessments_used,
      limit: userSubscription.psychological_assessments_limit,
