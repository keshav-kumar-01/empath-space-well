  ...
  try {
    const structuredData = {
      ...
      ...(type === "website" && {
        "potentialAction": {
          "@type": "SearchAction",
          "target": "https://chetna-ai.vercel.app/search?q={search_term_string}",
    ...
    const organizationData = {
      ...
      "url": "https://chetna-ai.vercel.app",
      "logo": "https://chetna-ai.vercel.app/logo.png",
    ...
    const softwareAppData = {
      ...
      "screenshot": "https://chetna-ai.vercel.app/og-image.png"
    };
